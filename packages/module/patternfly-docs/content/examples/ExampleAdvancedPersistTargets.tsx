...
export const ExampleAdvancedPersistTargets: React.FunctionComponent = () => {
  ...
  const batteries = useClientTableBatteries({
    persistTo: 'urlParams', // By default, features will persist to URL params. We override this under filter and pagination below. [TODO]
  ...
  return (
    <>
      <Toolbar>
        <ToolbarContent>
          <FilterToolbar id="persist-targets-example-filters" />
          {/* You can render whatever other custom toolbar items you may need here! */}
          <PaginationToolbarItem>
            <Pagination variant="top" isCompact widgetId="persist-targets-example-pagination" />
          </PaginationToolbarItem>
        </ToolbarContent>
      </Toolbar>
      ...
      <Pagination variant="bottom" isCompact widgetId="persist-targets-example-pagination" />
    </>
  );
};
