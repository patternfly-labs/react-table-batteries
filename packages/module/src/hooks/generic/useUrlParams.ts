...
export const useUrlParams = <TDeserializedParams, TKeyPrefix extends string, TURLParamKey extends string>({
  isEnabled = true,
  ...
  const withPrefixes = (serializedParams: TSerializedParams<TURLParamKey>): TSerializedParams<TPrefixedURLParamKey> =>
    persistenceKeyPrefix
